...
class ProductTests(TestCase):
    ...
    def setUp(self):
        ...
        self.test_ucproduct = GeneralProduct.objects.create(
            ...
            total_available_in_stock=self.uncountable_product[
                "total_available_in_stock"
            ],
    ...
    def test_category_created(self):
        ...
        self.assertEqual(self.test_cat.category_name, self.category["category_name"])
    ...
    def test_general_product_created(self):
        ...
        self.assertEqual(
            self.test_ucproduct.product_name, self.uncountable_product["product_name"]
        )
        self.assertEqual(self.test_ucproduct.brand, self.test_brand)
        self.assertEqual(self.test_ucproduct.subcategory, self.test_subcat)
        self.assertEqual(
        ...
        self.assertEqual(
            self.test_ucproduct.is_countable, self.uncountable_product["is_countable"]
        )

        self.assertEqual(
            self.test_cproduct.product_name, self.countable_product["product_name"]
        )
        self.assertEqual(self.test_cproduct.brand, self.test_brand)
        self.assertEqual(self.test_cproduct.subcategory, self.test_subcat)
        self.assertEqual(
            self.test_cproduct.product_description,
            self.countable_product["product_description"],
        )
        self.assertEqual(
            self.test_cproduct.price_per_unit, self.countable_product["price_per_unit"]
        )
        self.assertEqual(
        ...
        self.assertEqual(
            self.test_cproduct.is_countable, self.countable_product["is_countable"]
        )
